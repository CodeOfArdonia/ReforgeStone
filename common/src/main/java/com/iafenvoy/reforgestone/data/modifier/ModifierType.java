...
public record ModifierType<T extends Modifier<T>>(Identifier id, Codec<T> codec) {
    ...
    public static final ModifierType<MaxDamageModifier> MAX_DAMAGE = register(new ModifierType<>(Identifier.of(ReforgeStone.MOD_ID, "max_damage"), MaxDamageModifier.CODEC));
